...
<body class="animate__animated animate__fadeIn">
    <div class="dashboard-grid">
        ...
        <div class="sidebar p-6 animate__animated animate__fadeInLeft">
            ...
            <nav class="space-y-2">
                <a href="#" class="block p-2 text-gray-700 hover:bg-gray-100 rounded-lg">Tableau de bord</a>
                ...
                <a href="#" class="block p-2 text-gray-700 hover:bg-gray-100 rounded-lg">Statistiques</a>
